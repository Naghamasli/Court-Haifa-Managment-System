...
public class RemoveWitness extends JInternalFrame {
	...
	public RemoveWitness() {
		...
		allChoices = new JLabel("All Witness");
	    ...
	    for(int id: Court.getInstance().getAllWitnesses().keySet())
		{	
		...
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Witness w = Court.getInstance().getRealWitness((int) choiceBox.getSelectedItem());
				if(Court.getInstance().removeWitness(w) == true)
				{
                    JOptionPane.showMessageDialog(null, "Witness removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                    choiceBox.removeItem(w.getId());
				}
			 }
		});
	}
