...
public class GetRealMeeting extends JInternalFrame {
	...
	public GetRealMeeting(int user) {
        ...
        allChoicesLabel = new JLabel("AllMeetingss");
        ...
        if(Court.getInstance().getAllLawyers().containsKey(user)) {
        	if(Court.getInstance().getRealLawyer(user) instanceof Judge) {
        		 for (int id : Court.getInstance().getAllMeetings().keySet()) {
        			 Case c = Court.getInstance().getRealMeeting(id).getCasee();
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealMeeting((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealMeeting(selecteId).toString();
