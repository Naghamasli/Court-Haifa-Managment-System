...
public class RemoveDepartment extends JInternalFrame {
	...
	public RemoveDepartment() {
		...
		removeLb = new JLabel("Remove Department");
		...
		allChoices = new JLabel("All Departments");
		...
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Department d = Court.getInstance().getRealDepartment((int) choiceBox.getSelectedItem());
				if(Court.getInstance().removeDepartment(d) == true)
				{
                    JOptionPane.showMessageDialog(null, "Department removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                    choiceBox.removeItem(d.getNumber());
				}
			 }
		});
	}
