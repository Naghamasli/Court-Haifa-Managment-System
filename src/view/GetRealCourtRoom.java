...
public class GetRealCourtRoom extends JInternalFrame {
	...
	public GetRealCourtRoom() {
        ...
        allChoicesLabel = new JLabel("AllCourtRooms");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealCourtroom((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealCourtroom(selecteId).toString();
