...
public class FindInActiveCaseCountByDepartment extends JInternalFrame {
	...
	public FindInActiveCaseCountByDepartment() {
		setBounds(100, 100, 680, 540);
		getContentPane().setBackground(new Color(207, 207, 201));
		getContentPane().setLayout(null);
		
		label = new JLabel("Amount Of In-Active Cases By Department");
		...
		show.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HashMap<Department, Integer> answer = Court.getInstance().findInActiveCasesCountByDepartment();
