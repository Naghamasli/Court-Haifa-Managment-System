...
public class AddLawyer extends JInternalFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private JLabel addLawyerLb;
	private JLabel idLb;
	...
	public AddLawyer() {
		...
		addLawyerLb = new JLabel("Lawyer");
		addLawyerLb.setHorizontalAlignment(SwingConstants.CENTER);
		addLawyerLb.setBounds(132, 27, 317, 34);
		addLawyerLb.setFont(new Font("Book Antiqua", Font.BOLD, 20));
		addLawyerLb.setForeground(new Color(0, 64, 128));
		getContentPane().add(addLawyerLb);
		...
		licenseNumberLb.addKeyListener(new KeyAdapter() {
		    @Override
		    public void keyTyped(KeyEvent e) {
		        char c = e.getKeyChar();
		        if (!Character.isDigit(c)) {
            ...
            public void actionPerformed(ActionEvent e) {
	             ...
	             int ln = 0;
	                ...
	                try {
	                    ...
	                    try {
							Lawyer l = new Lawyer(id,fName,lName, parsedDate, adress, phoneNumber, email, gender,sp, ln,salary );
							Court.getInstance().addLawyer(l);
						} catch (InvalidBirthDateException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
	                    JOptionPane.showMessageDialog(null, "Lawyer added successfully!. The username and password is the ID", "Success", JOptionPane.INFORMATION_MESSAGE);
