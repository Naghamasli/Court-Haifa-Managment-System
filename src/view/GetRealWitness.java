...
public class GetRealWitness extends JInternalFrame {
	...
	public GetRealWitness() {
        ...
        allChoicesLabel = new JLabel("AllWitnesses");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealWitness((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealWitness(selecteId).toString();
