...
public class RemoveAppeal extends JInternalFrame {
	...
	public RemoveAppeal() {
		...
		removeLb = new JLabel("Remove Appeal");
		...
		allChoices = new JLabel("All Appeal");
	    ...
	    for(int id: Court.getInstance().getAllAppeals().keySet())
		{	
		...
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Appeal a = Court.getInstance().getRealAppeal((int) choiceBox.getSelectedItem());
				if(Court.getInstance().removeAppeal(a) == true)
				{
                    JOptionPane.showMessageDialog(null, "Appeal removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                    choiceBox.removeItem(a.getAppealID());
				}
			 }
		});
	}
