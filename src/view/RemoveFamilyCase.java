...
public class RemoveFamilyCase extends JInternalFrame {
	...
	public RemoveFamilyCase() {
		...
		allChoices = new JLabel("All FamilyCases");
		...
		{	
	    	if(Court.getInstance().getRealCase(id) instanceof FamilyCase)
			    	choiceBox.addItem(id);
		}
		
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FamilyCase c = Court.getInstance().getRealFamilyCase((String) choiceBox.getSelectedItem());
				if(Court.getInstance().removeFamilyCase(c) == true)
				{
                    JOptionPane.showMessageDialog(null, "FamilyCase removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
