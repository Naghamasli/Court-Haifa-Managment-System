...
public class GetRealTestimony extends JInternalFrame {
	...
	public GetRealTestimony() {
        ...
        allChoicesLabel = new JLabel("AllTestimonies");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealTestimony((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealTestimony(selecteId).toString();
