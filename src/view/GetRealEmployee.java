...
public class GetRealEmployee extends JInternalFrame {
	...
	public GetRealEmployee() {
        ...
        getRealLabel = new JLabel("GetRealEmployee");
        ...
        allChoicesLabel = new JLabel("AllEmployees");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealEmployee((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealEmployee(selecteId).toString();
