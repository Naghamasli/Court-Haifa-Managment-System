...
public class RemoveVerdict extends JInternalFrame {
	...
	public RemoveVerdict() {
		...
		removeLb = new JLabel("Remove Verdict");
		...
		allChoices = new JLabel("All Verdict");
	    ...
	    for(int id: Court.getInstance().getAllVerdicts().keySet())
		{	
		...
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Verdict v = Court.getInstance().getRealVerdict((int) choiceBox.getSelectedItem());
				if(Court.getInstance().removeVerdict(v) == true)
				{
                    JOptionPane.showMessageDialog(null, "Verdict removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                    choiceBox.removeItem(v.getVerdictID());
				}
			 }
		});
	}
