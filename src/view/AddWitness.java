...
public class AddWitness extends JInternalFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private JLabel addWitnessLb;
	private JLabel idLb;
	...
	public AddWitness() {
		...
		addWitnessLb = new JLabel("Witness");
		addWitnessLb.setHorizontalAlignment(SwingConstants.CENTER);
		addWitnessLb.setBounds(268, 30, 317, 34);
		addWitnessLb.setFont(new Font("Book Antiqua", Font.BOLD, 20));
		addWitnessLb.setForeground(new Color(0, 64, 128));
		getContentPane().add(addWitnessLb);
            ...
            public void actionPerformed(ActionEvent e) {
	             ...
	             int ln = 0;
	                ...
	                try {
	                    ...
	                    try {
							Witness l = new Witness(id,fName,lName, birthDate, adress, phoneNumber, email, gender);
							Court.getInstance().addWitness(l);
						} catch (InvalidBirthDateException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
	                    JOptionPane.showMessageDialog(null, "Witness added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
