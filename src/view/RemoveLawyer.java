...
public class RemoveLawyer extends JInternalFrame {
	...
	public RemoveLawyer() {
		...
		removeLb = new JLabel("Remove Lawyer");
		...
		allChoices = new JLabel("All Lawyers");
		...
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Lawyer l = Court.getInstance().getRealLawyer((int) choiceBox.getSelectedItem());
				if(Court.getInstance().removeLawyer(l) == true)
				{
                    JOptionPane.showMessageDialog(null, "Lawyer removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                    choiceBox.removeItem(l.getId());
				}
			 }
		});
	}
