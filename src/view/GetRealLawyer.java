...
public class GetRealLawyer extends JInternalFrame {
	...
	public GetRealLawyer() {
        ...
        allChoicesLabel = new JLabel("AllLawyers");
        allChoicesLabel.setBounds(149, 127, 123, 22);
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealLawyer((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealLawyer(selecteId).toString();
