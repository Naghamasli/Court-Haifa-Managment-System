...
public class GetRealVerdict extends JInternalFrame {
	...
	public GetRealVerdict() {
        ...
        allChoicesLabel = new JLabel("AllVerdicts");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealVerdict((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealVerdict(selecteId).toString();
