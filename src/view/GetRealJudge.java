...
public class GetRealJudge extends JInternalFrame {
	...
	public GetRealJudge() {
        ...
        getRealLabel = new JLabel("GetRealJudge");
        ...
        allChoicesLabel = new JLabel("AllJudgess");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealJudge((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealJudge(selecteId).toString();
