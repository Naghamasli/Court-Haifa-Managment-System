...
public class GetRealDepartment extends JInternalFrame {
	...
	public GetRealDepartment() {
        ...
        getRealLabel = new JLabel("GetRealDepartment");
        ...
        allChoicesLabel = new JLabel("AllDepartments");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealDepartment((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealDepartment(selecteId).toString();
