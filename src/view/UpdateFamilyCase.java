...
public class UpdateFamilyCase extends JInternalFrame {
	...
	public UpdateFamilyCase() {
		...
		JLabel ralationType = new JLabel("Relation Type");
		ralationType.setHorizontalAlignment(SwingConstants.LEFT);
		ralationType.setForeground(new Color(17, 80, 136));
		ralationType.setFont(new Font("Book Antiqua", Font.PLAIN, 17));
		ralationType.setBounds(459, 173, 194, 28);
		getContentPane().add(ralationType);
		...
		typeTxt.setForeground(new Color(0, 0, 51));
		typeTxt.setFont(new Font("Tahoma", Font.PLAIN, 15));
		typeTxt.setColumns(10);
		typeTxt.setBounds(600, 175, 136, 26);
		...
		for(String c: Court.getInstance().getAllCases().keySet()) {
			if(Court.getInstance().getRealCase(c) instanceof FamilyCase)
				caseBox.addItem(c);
		}
		...
		showBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	FamilyCase c = Court.getInstance().getRealFamilyCase((String)caseBox.getSelectedItem());
            	...
            	typeTxt.setText(c.getRelationType());
            }
		...
		doneBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	FamilyCase fc = null;
	                    ...
	                    fc = Court.getInstance().getRealFamilyCase((String) caseBox.getSelectedItem());

               try {
                    if(typeTxt.getText().isEmpty() || dateTxt.getText().isEmpty() || typeTxt.getText().isEmpty()) {
                    	throw new FieldsAreNotFullExp();
                    }
                	fc.setAccused(a);
                	fc.setCaseStatus(s);
                	fc.setCaseType(sp);
                	fc.setRelationType(type);
                	fc.setLawyer(l);
                	fc.setVerdict(v);
                	fc.setVictim(p);
