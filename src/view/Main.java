...
//        save();  // Save court data
        ...
        Court courtFromFile = SerializationHelp.loadCourt();
      	if (courtFromFile!=null)
	    Court.setInstance(courtFromFile);
	    Court.getInstance();
...
////            Judge judge = null;
////			try {
////				judge = new Judge(Integer.parseInt(args[0]),args[1],args[2],UtilsMethods.parseDate(args[3])
////						,args[4],args[5],args[6],Gender.valueOf(args[7]),Specialization.valueOf(args[8]),
...
//			try {
//				employee = new Employee(Integer.parseInt(args[0]),args[1],args[2],UtilsMethods.parseDate(args[3])
