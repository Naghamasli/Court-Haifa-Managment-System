...
public class RemoveCriminalCase extends JInternalFrame {
	...
	public RemoveCriminalCase() {
		...
		allChoices = new JLabel("All CriminalCase");
		...
		{	
	    	if(Court.getInstance().getRealCase(id) instanceof CriminalCase)
			    	choiceBox.addItem(id);
		}
		
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CriminalCase c = Court.getInstance().getRealCriminalCase((String) choiceBox.getSelectedItem());
				if(Court.getInstance().removeCriminalCase(c) == true)
				{
                    JOptionPane.showMessageDialog(null, "CriminalCase removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
