...
public class GetRealAppeal extends JInternalFrame {
	...
	public GetRealAppeal() {
        ...
        allChoicesLabel = new JLabel("AllAppeals");
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealAppeal(selecteId).toString();
