...
public class RemoveMeeting extends JInternalFrame {
	...
	public RemoveMeeting() {
		...
		removeLb = new JLabel("Remove Meeting");
		...
		allChoices = new JLabel("All Meetings");
		...
		removeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Meeting m = Court.getInstance().getRealMeeting((int) choiceBox.getSelectedItem());
				if(Court.getInstance().removeMeeting(m) == true)
				{
                    JOptionPane.showMessageDialog(null, "Meeting removed successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                    choiceBox.removeItem(m.getMeetingID());
				}
			 }
		});
	}
