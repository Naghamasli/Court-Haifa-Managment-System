...
public class GetRealDocument extends JInternalFrame {
	...
	public GetRealDocument() {
        ...
        allChoicesLabel = new JLabel("AllDocuments");
        ...
        show.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	 if(Court.getInstance().getRealDocument((int)allChoices.getSelectedItem()) != null)
                 {
            		 updateDetails();
                 }
            	}
    ...
    private void updateDetails() {
        ...
        String details = Court.getInstance().getRealDocument(selecteId).toString();
