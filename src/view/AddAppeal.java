...
public class AddAppeal extends JInternalFrame {
	...
	public AddAppeal() {
		...
		summeryTxt.setBounds(383, 109, 136, 135);
		...
		addBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               ...
               try {
                    ...
                    JOptionPane.showMessageDialog(null, "Appeal "+ p.getAppealID() +" added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                    clearFields();
